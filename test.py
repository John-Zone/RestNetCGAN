...
Flags.DEFINE_string('checkpoint', './0426/model-40000', 'If provided, the weight will be restored from the provided checkpoint')
...
Flags.DEFINE_string('input_data_dir', './data/test.mat', 'The directory of the input resolution input data')
...
Flags.DEFINE_float('learning_rate_dis', 0.0001, 'The learning rate for the discriminator')
Flags.DEFINE_float('learning_rate_gen', 0.00005, 'The learning rate for the generator')
